package co.edu.javerianacali.educacioncontinua.diplomado.kafka.inventory.consumer.infraestructure.kafka.configurations;
...
public class KafkaConsumerTemplateConfiguration {
  ...
  public ConsumerFactory<String, SaleEvent> consumerFactory() {
    ...
    props.put(ConsumerConfig.GROUP_ID_CONFIG, "restaurant_inventory");
    props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
    props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);

    props.put(
        JsonDeserializer.VALUE_DEFAULT_TYPE,
        "co.edu.javerianacali.educacioncontinua.diplomado.kafka.inventory.consumer.infraestructure.kafka.events.SaleEvent");
